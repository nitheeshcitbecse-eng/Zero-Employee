  ...
  return (
    <div className={cn("agent-settings-content mx-auto max-w-5xl space-y-8", `agent-settings-${activeView}`)}>
      ...
      {builtInState && (
        ...
        >
          Ships with Zero and powers <strong>{builtInFeatureLabel}</strong>. Configure it like
                ...
                <span className="text-xs font-medium text-muted-foreground flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right" sideOffset={4}>
                      Managed: Zero stores and serves the instructions bundle. External: you provide a path on disk where the instructions live.
                    </TooltipContent>
                  </Tooltip>
                </span>
                <div className="flex gap-2">
              ...
              <label className="space-y-1.5 min-w-0">
                <span className="text-xs font-medium text-muted-foreground flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right" sideOffset={4}>
                      The absolute directory on disk where the instructions bundle lives. In managed mode this is set by Zero automatically.
                    </TooltipContent>
                  </Tooltip>
                </span>
                {currentMode === "managed" ? (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-border rounded-lg p-4 space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          API keys allow this agent to authenticate calls to the Zero server.
        </p>
        <div className="flex items-center gap-2">
          <Input
