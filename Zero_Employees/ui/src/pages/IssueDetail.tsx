...
const IssueDetailChatTab = memo(function IssueDetailChatTab({
  ...
  // the protocol: native Zero turns can steer in place, while legacy
      ...
      try {
        ...
        if (code === "queued_comment_already_dispatching") {
          pushToast({
            ...
            body: "The continuation started before the discard was confirmed, so Zero could not unsend it.",
            tone: "error",
            ttlMs: 15_000,
