      ...
      <main className="mx-auto max-w-lg space-y-5 px-6 py-12">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            Zero permissions in {identity.companyName}.
          </p>
        </div>
        <Button asChild>
          <Link
