  ...
  const loadPrivateKeyFile = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setPrivateKeyFileError(
        error instanceof Error
          ? error.message
          : "Zero couldn't read that file. Choose the .pem file again or paste the private key.",
      );
    } finally {
...
features:
  ...
  agent_view:
    agent_description: "Work with a Zero agent in a task-backed conversation."
  bot_user:
          ...
          commandLists: [
            {
              ...
              commands: [
                {
                  title: "/status",
                  description: "Show the active Zero task status",
                },
                {
                  title: "/new",
                  description: "Start a new Zero task in this chat",
                },
                {
                  title: "/close",
    ...
    return (
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {repairing
              ...
              : "Create one dedicated Discord application and bot for this Zero agent."}
          </p>
        </div>
      <ol className="list-decimal space-y-2 pl-5 text-sm">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Reactions, Embed Links, and Attach Files. Zero still requires
    ...
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {repairing
              ? "Reconnect verifies this same BotFather bot and automatically refreshes its Zero webhook and command menu. It does not recreate the bot or change its chat memberships. Leave the token blank to reuse the saved credential."
        ...
        <p className="rounded-md border border-border bg-muted/40 p-3 text-sm text-muted-foreground">
          Zero works with Telegram&apos;s default bot privacy mode and
        ...
        {!endpoint.setup?.webhookUrl && (
          <p className="text-sm text-destructive">
            Configure a public HTTPS URL for this Zero instance before
            connecting Telegram.
          </p>
        )}
        <Button
      ...
      <div className="space-y-5">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm">
          ...
          <li>
            ...
            Application ID, set its messaging endpoint to the Zero URL
        ...
        <section className="space-y-3 rounded-lg border border-border p-4">
          ...
          <ol className="list-decimal space-y-3 pl-5 text-sm">
            ...
            <li>
              ...
              <strong>Settings · Configuration</strong> and paste the Zero{" "}
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Zero-specific fields to verify in Developer Portal or merge into
        ...
        <p className="text-sm text-muted-foreground">
          Zero does not use Teams single sign-on in this release. The
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Zero retains and acts only on messages admitted by your Zero
  ...
  if (provider === "github")
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {repairing
              ...
              : "Configure its webhook and permissions, then verify the App with Zero."}
          </p>
        </div>
        {!repairing && (
          <ol className="list-decimal space-y-2 pl-5 text-sm">
            <li>
              ...
              Zero homepage URL below, and leave user authorization off.
            </li>
            <li>
              Keep <strong>Webhooks · Active</strong> on. Enter the Zero
              webhook URL and the Zero-generated webhook secret below, and
        ...
        {endpointValue("Zero webhook URL", endpoint.setup?.webhookUrl)}
        <Button
          variant="outline"
          onClick={() =>
            window.open(
        ...
        <div className="grid gap-2">
          ...
          {generatedWebhookSecret ? (
            <>
              ...
              <p className="text-sm text-muted-foreground">
                Copy this value now. Zero will not show it again.
              </p>
            </>
          ) : (
            <p className="text-sm text-muted-foreground">
              {endpoint.setup?.webhookSecretConfigured
                ...
                : "Generate the secret in Zero, then paste it into the GitHub App."}
            </p>
          )}
          <div>
            <Button
    ...
    return (
      <div className="space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Point the Slack app at Zero now that its signing secret is
            connected.
          </p>
        </div>
        {endpointValue("Zero webhook URL", endpoint.setup?.webhookUrl)}
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm">
          <li>
            ...
            Events URL when you save; Zero records Interactivity and slash
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {repairing
            ...
            : "Bring your own Slack app. The manifest requests the scopes Zero needs; credentials remain write-only."}
        </p>
      </div>
      <ol className="list-decimal space-y-2 pl-5 text-sm">
        <li>
...
function TryStep({
        ...
        : unlinkedIdentities.length > 0
          ? guestIsolationState === "disabled"
            ? {
                tone: "warning" as const,
                title: "Link the account you’re testing",
                body: `An observed external account is unlinked, and isolated guest work is off, so it cannot safely start ${agentName}. Link the account in Access, then ${freshConversationInstruction}; Zero does not replay the refused request.`,
              }
            : {
                tone: "info" as const,
  ...
  const instructions =
    provider === "imessage-photon" ? [
      ...
      "Link the discovered sender to a Zero person in Access, then send a fresh request.",
