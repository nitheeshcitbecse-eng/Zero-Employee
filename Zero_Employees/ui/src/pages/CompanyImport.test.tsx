...
describe("CompanyImport", () => {
  ...
  it("hides Zero Runner import configuration while its experimental flag is off", async () => {
    mockAdaptersApi.list.mockResolvedValue([
      { type: "claude_local", disabled: false },
      { type: "codex_local", disabled: false },
  ...
  it("offers Zero Runner import configuration after its experimental flag is enabled", async () => {
    mockAdaptersApi.list.mockResolvedValue([
      { type: "claude_local", disabled: false },
      { type: "codex_local", disabled: false },
