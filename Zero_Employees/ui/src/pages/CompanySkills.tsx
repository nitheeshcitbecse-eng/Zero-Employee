...
function sourceMeta(sourceBadge: CompanySkillSourceBadge, sourceLabel: string | null) {
  ...
  switch (sourceBadge) {
    ...
    case "paperclip":
      return { icon: Paperclip, label: sourceLabel ?? "Zero", managedLabel: "Zero managed" };
    default:
...
function CompatChip({ compatibility }: { compatibility: CompanySkillCompatibility }) {
  ...
  const map = {
    unknown: {
      ...
      tooltip: "Zero could not validate this skill as Agent Skills markdown. Install at your own risk.",
...
export function CompanySkills() {
  ...
  const createSkill = useMutation({
    ...
    onSuccess: async (skill) => {
      ...
      pushToast({
        ...
        body: `${skill.name} is now editable in the Zero workspace.`,
      });
    },
    onError: (error) => {
  ...
  const studioDescription = studioForkFromId
    ...
    : "Create an editable organization skill in the Zero workspace.";
  return (
    <>
      {policyDenial.denial ? (
