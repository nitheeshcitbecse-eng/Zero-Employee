    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Every component, style, and pattern used across Zero.
        </p>
      </div>
      ...
      <Section title="Breadcrumb">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Zero App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {["running", "queued", "succeeded", "failed", "timed_out", "cancelled", "interrupted"].map((status) => (
              <AgentRunCard
                ...
                issue={{ identifier: "PAP-559", title: "Recreate this wireframe on pages Zero", status: status === "succeeded" ? "done" : "in_progress" }}
              />
            ))}
          </div>
      ...
      <Section title="Inline Banner">
        ...
        <div className="space-y-3">
          ...
          >
            Ships with Zero and powers <strong>Briefs</strong>. It can be paused but not deleted.
          </InlineBanner>
          <InlineBanner
            tone="warning"
