...
import { ZeroLoading } from "./components/ZeroMark";
...
function ProductionSurface({ children }: { children: ReactNode }) {
  return <Suspense fallback={<ZeroLoading />}>{children}</Suspense>;
}
  ...
  return (
    <>
      <Routes>
        ...
        <Route element={streamlinedUiLoaded ? <CloudAccessGate /> : <ZeroLoading />}>
