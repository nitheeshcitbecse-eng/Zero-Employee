...
describe("OnboardingWizard adapter selection", () => {
  ...
  it("keeps onboarding on legacy adapters even when Zero Runner is enabled", async () => {
    mockAdapterRegistry.list = [
  ...
  it("normalizes a saved Zero Runner draft before adapter discovery resolves", async () => {
