 ...
 * interstitial into its status line; the Zero Runner task surface instead
...
/**
 * Semantic rows for the Zero runner's Codex-style activity disclosure.
 *
...
/**
 * Ordered input for the Zero Runner task-turn timeline. This keeps the
      ...
      switch (key) {
        ...
        case "paperclip_read":
          text =
            count === 1
              ? "Read from Zero"
              : `Read from Zero ${count} times`;
          break;
        case "task_operation":
          text =
            count === 1 ? "Used Zero" : `Used Zero ${count} times`;
          break;
        default:
