...
vi.mock("@/context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "Zero", issuePrefix: "PAP" },
  }),
}));
...
describe("InvitesSection", () => {
  ...
  it("renders a human-only invite flow and keeps invite history in a table", async () => {
    ...
    expect(container.textContent).toContain("This URL includes the current Zero domain returned by the server.");
