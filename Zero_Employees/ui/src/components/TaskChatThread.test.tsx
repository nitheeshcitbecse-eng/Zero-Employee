...
describe("TaskChatThread runtime transcript selection", () => {
  ...
  it("uses runner-only controls only for an actual native Zero Runner run", () => {
...
describe("TaskChatThread no-live-execution-path recovery", () => {
  const noLivePathComment = {
    ...
    authorAgentId: null,
    authorUserId: null,
    body: "Zero retried continuation, but it still has no live execution path.",
    presentation: {
...
describe("TaskChatThread Zero Runner queue", () => {
  const queuedComment = {
    id: "queued-prp-1",
    companyId: "company-1",
    issueId: "issue-1",
    ...
    render(
      <TaskChatThread
        ...
        activeRun={{
          ...
          // a Zero request while the linked-run adapter classification is
          // still stale.
          adapterType: "codex_local",
        }}
      />,
