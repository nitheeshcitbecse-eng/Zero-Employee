...
// instance administrator has opted into Zero Runner elsewhere. The
...
const DEFAULT_TASK_TITLE = "Zero onboarding";
/**
...
function OnboardingWizardInner({
  ...
  const {
    ...
    // resolve against the local Zero host (environmentId = null).
  ...
  */
  ...
  async function handleGiveHeartbeat() {
    ...
    if (adapterType === "paperclip_runner") {
      setAdapterType("claude_local");
      setModel("");
      setError("Zero Runner is not available during onboarding. Choose a legacy adapter.");
      return;
    }
    if (createdAgentId) {
      setStep(5);
                    ...
                    <OnboardingHeading
                      ...
                      lede={
                        step === 3 ? undefined : step === 4 ? (
                          <>Zero works with your subscription or API keys.</>
                        ) : (
              ...
              {step === 1 && (
                <div className="mx-auto w-full space-y-9">
                  <OnboardingHeading
                    ...
                    lede="Welcome to Zero — let's set up your organization."
                  />
