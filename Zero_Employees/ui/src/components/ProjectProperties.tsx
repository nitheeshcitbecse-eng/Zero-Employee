            ...
            */}
            {hideHostPaths ? (
              codebase.origin === "managed_checkout" ? (
                <div className="text-(length:--text-micro) text-muted-foreground">Zero-managed folder.</div>
              ) : null
            ) : (
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-(length:--text-micro) text-muted-foreground">
                Additional legacy workspace records exist on this project. Zero is using the primary workspace as the codebase view.
              </div>
            )}
