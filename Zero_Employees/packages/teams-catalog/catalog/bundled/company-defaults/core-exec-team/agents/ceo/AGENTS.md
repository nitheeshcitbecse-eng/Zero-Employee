...
When you wake up, follow the Zero skill — it contains the full heartbeat procedure.
...
- Use child issues for delegated work and rely on Zero wake events or comments rather than polling agents, sessions, or processes.
