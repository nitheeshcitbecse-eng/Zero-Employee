...
export const chatEndpoints = pgTable(
  ...
  (table) => [
    ...
    // A native provider identity can back only one live Zero endpoint.
    ...
    // two Zero agents after both application-level prechecks passed.
    ...
    // two Zero agents through two different webhook URLs.
...
export const chatConversations = pgTable(
  "chat_conversations",
  {
    ...
    // used for replies while allowing completed Zero tasks to roll over.
