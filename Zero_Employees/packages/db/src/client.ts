...
export interface DatabaseClientOptions {
   ...
   * `pg_stat_activity.application_name`. Lets an operator tell Zero's
 ...
 * Zero's own defaults on top, and the driver defaults apply to the rest
...
/**
 * Fills in Zero's defaults for the options the caller left unset: idle
