...
export const INSTANCE_FEATURE_CATALOG: Record<InstanceFeatureKey, FeatureCatalogEntry> = {
  ...
  enableNativeRunner: {
    title: "Zero Runner",
    description:
      "Allow explicitly configured local Codex, OpenCode, and qualified ACPX agents to use the experimental Rust Zero Runner, including authenticated sandbox ingress when required. Onboarding remains on legacy adapters.",
    tier: "managed",
    cloudDefault: false,
  ...
  enableBuiltInAgents: {
    ...
    description:
      "Show Zero-managed built-in agent surfaces, including roster badges, the Built-in agents tab, and setup controls.",
    tier: "managed",
    cloudDefault: false,
    selfHostedDefault: false,
  },
  enableBetaSkills: {
    title: "Beta skills",
    description: "Allow agents to pin beta releases of the Zero core skill.",
    tier: "preference",
    cloudDefault: false,
    selfHostedDefault: false,
  },
  ...
  enablePaperclipDeveloperMode: {
    ...
    description:
      "Show internal Zero maintainer tools and observability links, including Honeycomb trace queries on run pages.",
    tier: "preference",
    cloudDefault: false,
    selfHostedDefault: false,
  },
  ...
  enableRunnerPreviewIngress: {
    ...
    description:
      "Compatibility-only key retained for older managed configs. Runner ingress follows the Zero Runner setting.",
    tier: "managed",
    cloudDefault: false,
    selfHostedDefault: false,
  },
