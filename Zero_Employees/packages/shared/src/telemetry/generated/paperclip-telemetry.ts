...
export const PAPERCLIP_ENUM_DESCRIPTIONS = {
  ...
  "company.imported": {
    "source_type": {
      ...
      "catalog": "Import source came from a Zero catalog entry.",
  ...
  "interaction.resolved": {
    ...
    "resolved_by_kind": {
      ...
      "system": "Zero resolved the interaction automatically.",
...
installId: string
/**
 * Optional client application build version. Zero clients report PEP 440
