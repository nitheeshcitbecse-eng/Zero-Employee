...
> Research Notion's hosted MCP server and prepare it for Zero. Start from
...
6. Stop with the issue in review. No Zero App branch exists yet.
...
After acceptance, create one isolated Zero App worktree and PR for
