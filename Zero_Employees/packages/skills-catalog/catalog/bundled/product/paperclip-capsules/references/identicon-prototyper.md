...
Use this reference when generating or reviewing deterministic Zero capsule identicons/profile pills. Prototype source paths, when the Zero content repository is available:
