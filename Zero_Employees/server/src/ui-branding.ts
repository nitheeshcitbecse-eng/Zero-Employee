const FAVICON_BLOCK_START = "<!-- ZERO_FAVICON_START -->";
const FAVICON_BLOCK_END = "<!-- ZERO_FAVICON_END -->";
const RUNTIME_BRANDING_BLOCK_START = "<!-- ZERO_RUNTIME_BRANDING_START -->";
const RUNTIME_BRANDING_BLOCK_END = "<!-- ZERO_RUNTIME_BRANDING_END -->";
