...
describe("codex local skill sync", () => {
  ...
  it("defaults the operational Zero skill for workspace injection on the next run", async () => {
  ...
  it("does not persist Zero skills into CODEX_HOME during sync", async () => {
  ...
  it("normalizes legacy flat Zero skill refs before reporting configured state", async () => {
