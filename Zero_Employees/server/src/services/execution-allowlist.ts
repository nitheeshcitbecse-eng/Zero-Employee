 ...
 *   never executes on the tenant's Zero-operated container. Unlike
 ...
 *   rather than executing on Zero compute.
 */
...
export function evaluateExecutionAllowlist(
  ...
  // agent code must never run in-process / on the tenant's Zero
