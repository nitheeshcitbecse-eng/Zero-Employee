...
export function vercelConnectFailureMessage(code: VercelConnectFailureCode): string {
  switch (code) {
    case "vercel_connect_unavailable":
      return "Vercel Connect is not configured on this Zero instance.";
    case "vercel_connect_auth_failed":
      return "Zero could not authenticate to Vercel Connect. Repair or refresh the instance's Vercel authority.";
    ...
    case "vercel_connect_installation_required":
      return "This connector must be installed or attached in Vercel before Zero can use it.";
    default:
 ...
 * Zero's local board commonly runs on 127.0.0.1, which is the same
