...
export function paperclipCloudConnectorConfigFromEnv(
  ...
  if (!hasManagedIdentityOverride && !hasActiveLocalIdentity && legacyConfigured) {
    throw new PaperclipCloudConnectorError(
      "Zero ID connector settings use an incompatible legacy protocol; enroll this instance with Paperclip Cloud",
...
/** Accept persisted Zero ID-era records while all new records use the Cloud strategy. */
