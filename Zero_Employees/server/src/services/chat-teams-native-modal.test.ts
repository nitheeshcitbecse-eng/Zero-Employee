...
// Chat SDK into Zero's callbacks. Only the instance JWT check is replaced;
...
describe("Teams native task module adapter-to-runtime boundary", () => {
  ...
  it("round-trips the Zero form through task/fetch and task/submit with exact opaque fields and source", async () => {
