  ...
  return {
    ...
    async installFixtures(companyId: string, actor?: SmokeLabActorInfo) {
      ...
      const httpApp = await ensureApplication({
        ...
        description: "Deterministic loopback HTTP MCP fixture for Zero smoke scenarios.",
        type: "mcp_http",
      });
      const stdioApp = await ensureApplication({
        ...
        name: "Smoke Lab stdio MCP fixture",
        description: "Deterministic stdio MCP fixture for Zero smoke scenarios.",
        type: "mcp_stdio",
      });
