...
export const SUCCESSFUL_RUN_HANDOFF_REQUIRED_NOTICE_BODY =
  "Zero needs a disposition before this issue can continue.";
export const SUCCESSFUL_RUN_HANDOFF_EXHAUSTED_NOTICE_BODY =
  "Zero could not resolve this issue's missing disposition automatically. The source assignment is unchanged and a board decision is required.";
...
export function buildSuccessfulRunHandoffInstruction(input: {
  ...
  return [
    ...
    "",
    "## What happened",
    "Your last run on this issue ended successfully, but the issue is still `in_progress` and has no valid disposition — Zero cannot tell whether the work is finished, blocked, or unfinished.",
    ...(report
      ? [
          "",
    ...
    "",
    "## Your options",
    "Choose **exactly one** outcome and perform the matching Zero action:",
    "",
