 ...
 * `dist` in a built server; both sit inside the Zero checkout. A server
 ...
 * is a Zero-specific variable, not an OpenTelemetry SDK variable, so
 * Zero controls this precedence.
 */
